...
public class MainActivity extends AppCompatActivity
    ...
    public native void runCvMain(long matAddrInput, long matAddrResult, int mode);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        runCvMain(matInput.getNativeObjAddr(), matResult.getNativeObjAddr(), currentMode.getValue());
